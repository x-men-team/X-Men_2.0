...
[ State($Human,'2',<$oyster,$ccard,bal($oyster),bal($ccard)>)
, SndS($Human,$GateIn,<'card','card','balance','balance'>,<$oyster,$ccard,bal($oyster),bal($ccard)>)
]

rule GateIn_1_M:
[ State($GateIn,'1',<~gid>)
, RcvS($Human,$GateIn,<'card','card','balance','balance'>,<$oyster,$ccard,bal($oyster),bal($ccard)>)
]
--[ Receive($GateIn,$Human,$oyster)
